...
public class Narrator {
        ...
        public static void showIntro() {
                ...
                System.out.println(ConsoleUtils.RED
                                + "============================================================================================="
                                + ConsoleUtils.RESET);
                System.out.println(ConsoleUtils.RED + "                                 SOOT FALLOUT"
                                + ConsoleUtils.RESET);
                System.out.println(
                                ConsoleUtils.GRAY + "                               The Sun is just a memory."
                                                + ConsoleUtils.RESET);
                System.out.println(ConsoleUtils.RED
                                + "============================================================================================="
                                + ConsoleUtils.RESET);
                if (currentLanguage == Language.ID) {
                        ...
                        System.out.println(
                                        "Anda, seorang Thermo-Scavenger, ditugaskan untuk menjelajah Stasiun Relay Daya yang ditinggalkan");
                        ...
                        System.out.println(
                                        "It is the consequence of global industry and coal burning, which for hundreds of years");
                        ...
                        System.out.println(
                                        "powered by a Geothermal Core—the only remaining source of heat and electricity.");
                        System.out.println("\nThe Geothermal Core in the bunker is beginning to fail.");
                        System.out.println(
                                        "You, a Thermo-Scavenger, have been tasked to venture into the abandoned Power Relay Station");
        ...
        public static void showLocation(String locationName) {
                if (currentLanguage == Language.ID) {
                        ...
                        System.out.println(
                                        "\nENTERING LOCATION: " + ConsoleUtils.YELLOW + locationName
                                                        + ConsoleUtils.RESET);
                }
                if (locationName.equals("Service Tunnels")) {
                        System.out.println(
                                        currentLanguage == Language.ID
                                                        ? "Terowongan gelap dan berbau lembab. Anda mendengar suara gesekan di depan."
                                                        : "The tunnel is dark and smells of damp. You hear scraping sounds ahead.");
                } else if (locationName.equals("Outer Power Station")) {
                        System.out.println(
                                        currentLanguage == Language.ID
                                                        ? "Jelaga turun seperti salju hitam di area terbuka ini. Sebuah bayangan melihat Anda."
                                                        : "Soot falls like black snow in this open area. A shadow spots you.");
                        ...
                        System.out.println(
                                        currentLanguage == Language.ID
                                                        ? "Inilah tempatnya. Ruangan besar berdengung dengan daya sisa."
                                                        : "This is it. The large room hums with residual power.");
                        System.out.println(
                                        currentLanguage == Language.ID
                                                        ? "Di tengah ruangan, sebuah robot besar aktif. 'Station Sentinel'."
                                                        : "In the center of the room, a large robot activates. 'Station Sentinel'.");
                }
        }
        ...
        public static void showEndingA_Success() {
                ...
                if (currentLanguage == Language.ID) {
                        System.out.println(ConsoleUtils.GREEN
                                        + "                               ENDING: KELEMBELENGAN SEMENTARA"
                                        + ConsoleUtils.RESET);
                        System.out.println(ConsoleUtils.GREEN
                                        + "=============================================================================="
                                        + ConsoleUtils.RESET);
                        System.out.println();
                        AsciiArt.showVictoryAssembly();
                        System.out.println("Anda kembali dengan komponen-komponen. Para teknisi memasangnya,");
                        System.out.println(
                                        "dan Inti Geotermal stabil kembali. Dengungan uap yang menenangkan kembali hadir.");
        ...
        public static void showEndingB_Fail() {
                ...
                if (currentLanguage == Language.ID) {
                        System.out.println(ConsoleUtils.RED
                                        + "                             ENDING: KEMATIAN DALAM DINGIN ABADI"
                                        + ConsoleUtils.RESET);
                        System.out.println(ConsoleUtils.RED
                                        + "=============================================================================="
                                        + ConsoleUtils.RESET);
                        ...
                        System.out.println(
                                        ConsoleUtils.RED + "                                  ENDING: THE ETERNAL COLD"
                                                        + ConsoleUtils.RESET);
                        System.out.println(ConsoleUtils.RED
                                        + "=============================================================================="
                                        + ConsoleUtils.RESET);
                        ...
                        System.out.println(
                                        "The Caldera Bunker has become a tomb, just as cold as the ashfall outside.");
                        System.out.println(ConsoleUtils.RED + "\nGAME OVER." + ConsoleUtils.RESET);
                }
        }
        // separator
        ...
        public static void showRevivePrompt(int chargesLeft) {
                if (currentLanguage == Language.ID) {
                        ...
                        System.out.println(ConsoleUtils.RED + "\nCRITICAL WARNING: VITAL SIGNS FAILING."
                                        + ConsoleUtils.RESET);
                        System.out.println("Emergency Medical Protocol initiated....");
                        System.out.println(
                                        "Call for Medical Extraction Bot? (Charges remaining: " + chargesLeft + "/3)");
        ...
        public static void showReviveSuccess() {
                ...
                AsciiArt.showMedBot();
                if (currentLanguage == Language.ID) {
                        System.out.println(ConsoleUtils.GREEN + "\nEkstraksi dikonfirmasi. Meluncurkan Med-Bot..."
                                        + ConsoleUtils.RESET);
                        ...
                        System.out.println(ConsoleUtils.GREEN + "\nExtraction confirmed. Deploying Med-Bot..."
                                        + ConsoleUtils.RESET);
        ...
        public static void showRestartPrompt() {
                if (currentLanguage == Language.ID) {
                        System.out.println(ConsoleUtils.YELLOW
                                        ...
                                        + ConsoleUtils.RESET);
                        System.out.print(
                                        "Apakah Anda ingin memulai ulang petualangan dan mencoba menyelamatkan Bunker lagi? (y/n)");
                } else {
                        System.out.println(ConsoleUtils.YELLOW
                                        + "\nThe simulation has ended, but the timeline remains malleable."
                                        + ConsoleUtils.RESET);
                        System.out.print(
                                        "Do you wish to restart the adventure and try to save the Bunker again? (y/n)");
                }
        }
}